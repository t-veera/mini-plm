#!/bin/bash
# Mini-PLM Install Script for macOS
...
# wants to be somewhere with room and somewhere you back up. An external drive is
# fine as long as it is mounted before Docker starts.
